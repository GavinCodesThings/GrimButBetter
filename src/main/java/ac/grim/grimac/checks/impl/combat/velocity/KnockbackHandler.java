package ac.grim.grimac.checks.impl.combat.velocity;
...
@CheckData(name = "Velocity A (Normal)", alternativeName = "AntiKnockback", configName = "Knockback", setback = 10, decay = 0.025)
